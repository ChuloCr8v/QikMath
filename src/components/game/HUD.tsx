...
export const HUD = () => {
  ...
  return (
    <div className="absolute top-6 left-1/2 -translate-x-1/2 w-[calc(100%-24px)] md:w-full max-w-5xl p-3 sm:p-5 flex items-center justify-around z-40 gap-3 bg-white/95 rounded-2xl sm:rounded-3xl border-4 border-amber-300 shadow-[0_6px_0px_#fecf33]">
      <div className="flex items-center gap-3 sm:gap-6 flex-1 min-w-0">
        {/* TIME BAR & CLOCK */}
          <div className={`w-16 text-sm sm:text-xl font-bold ${timeLeft <= 5 ? 'text-red-500 scale-110 animate-bounce' : 'text-slate-700'} transition-all`}>
            ⏰ {timeLeft}s
          </div>
        ...
        <div className="flex flex-col min-w-0">
          <div className="flex items-center gap-2 mt-1 shrink-0">
            <div className="w-[80%] h-2.5 bg-slate-100 border border-slate-200 rounded-full overflow-hidden">
              <div 
            ...
            <span className="text-[9px] block w-[20%] text-slate-500 font-bold font-mono">
          ...
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span className="text-[10px] sm:text-xs font-bold text-sky-400 capitalize">
              {levelTitle}
            </span>
          </div>
